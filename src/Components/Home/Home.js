  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          <img src="https://www.skcet.ac.in/images/logo.png" alt="" style={{paddingLeft:'450px'}}></img>
        ...
        >
          <Container maxWidth="sm">
            ...
            >
              ...
              <Button variant="contained">Placements</Button>              
              <Button variant="contained">Exams</Button>             
              <Button variant="text">Online fee payment</Button>
            </Stack>
          </Container>
        </Box>
